...
class PriorityMessage {
    ...
    public PriorityMessage(FTMessage msg, int priority) {
        this.msg = msg;
    ...
    public PriorityMessage(FTMessage msg, int priority, boolean syncReply) {
        this(msg, priority);
        this.syncReply = syncReply;
    }

    public FTMessage getMsg() {
        return msg;
    }

    public void setMsg(FTMessage msg) {
        this.msg = msg;
    }
